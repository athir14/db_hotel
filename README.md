...
```
## 6. INNER JOIN 
Menampilkan data reservasi lengkap dengan nama pelanggan dan nomor kamar.
```
...
## 7. LEFT JOIN 
Menampilkan semua pelanggan, termasuk yang belum reservasi.
```
...
## 8. Right Join 
Menampilkan semua kamar, termasuk yang belum pernah dipesan.
```
